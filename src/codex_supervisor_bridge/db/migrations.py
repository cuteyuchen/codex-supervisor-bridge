...
from .schema import (
    ...
    BACKEND_BINDING_MIGRATION_SQL,
    CHECKPOINT_MIGRATION_SQL,
    CODEX_RUNTIME_ISOLATION_MIGRATION_SQL,
...
MIGRATIONS: dict[int, str] = {
    ...
    4: HARD_REPLAN_MIGRATION_SQL,
    5: EXECUTION_STATE_MIGRATION_SQL,
    6: WORKSPACE_STATE_MIGRATION_SQL,
    7: AGENT_SAFETY_MIGRATION_SQL,
    8: BACKEND_BINDING_MIGRATION_SQL,
    9: CODEX_RUNTIME_ISOLATION_MIGRATION_SQL,
}
